...
export const barSchwarz = new SpezialFelder (27,"barschwarz",0,"mitte","oben");
export const ausstiegSchwarz = new SpezialFelder (0,"ausstiegSchwarz",0,"rechts","unten");
export const ausstiegWeiß = new SpezialFelder (25,"ausstiegWeiß",0,"rechts","oben");
                ...
                setTimeout(() => {
                    ...
                    if (gegnerSteineAnzahl === 1) {
                        ...
                        if (geschlagenerStein) {
                            ...
                            if (gegnerFarbe === "Weiß") barWeiß.anzahlSteine++ ; else barSchwarz.anzahlSteine++;
                        }
                    }
